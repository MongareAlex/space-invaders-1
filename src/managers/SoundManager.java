	...
	public static void init() {
		...
		try {
			sounds[EXPLOSION] = AudioLoader.getAudio("WAV",
					ResourceLoader.getResourceAsStream("assets/sound/explosion.wav"));
			sounds[INVADER1] = AudioLoader.getAudio("WAV", 
					ResourceLoader.getResourceAsStream("assets/sound/fastinvader1.wav"));
			sounds[INVADER2] = AudioLoader.getAudio("WAV", 
					ResourceLoader.getResourceAsStream("assets/sound/fastinvader2.wav"));
			sounds[INVADER3] = AudioLoader.getAudio("WAV", 
					ResourceLoader.getResourceAsStream("assets/sound/fastinvader3.wav"));
			sounds[INVADER4] = AudioLoader.getAudio("WAV", 
					ResourceLoader.getResourceAsStream("assets/sound/fastinvader4.wav"));
			sounds[INVADER_KILLED] = AudioLoader.getAudio("WAV", 
					ResourceLoader.getResourceAsStream("assets/sound/invaderkilled.wav"));
			sounds[SHOOT] = AudioLoader.getAudio("WAV", 
					ResourceLoader.getResourceAsStream("assets/sound/shoot.wav"));
			sounds[UFO] = AudioLoader.getAudio("WAV", 
					ResourceLoader.getResourceAsStream("assets/sound/ufo.wav"));
			
			backgroundMusic = new Music("assets/music/bg-music.ogg");
